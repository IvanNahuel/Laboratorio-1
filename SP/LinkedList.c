...
//map debe agregar al nodo el sueldo generado, en cada iteracion
/*
int al_map(LinkedList*this,void (*pFunc)(void*),int indice,void*str)
{
    void*AuxThing;

    //lo que podemos hacer es obtener

    if (this!=NULL && indice>0 && indice<ll_len(this) && pFunc!=NULL){
        //AuxThing = pFunc();




    //hacer un nuevo add donde añadimos a la lista los nuevos datos que faltan por ejemplo
    //el dato que falta es sueldo
    //hacemos un new parametros peeeeeero con el sueldo incluido
